package com.keletu.emt.tile.solar.dark;
...
public class TileEntityDarkSolar extends TileEntitySolarBase {
    ...
    public void createEnergy() {
        if(world.canBlockSeeSky(new BlockPos(pos.getX(),pos.getY()+1,pos.getZ()))&&!world.isDaytime()&&!world.isRaining()&&!world.isThundering()){
    ...
    public List<ItemStack> getWrenchDrops(World world, BlockPos blockPos, IBlockState iBlockState, TileEntity tileEntity, EntityPlayer entityPlayer, int i) {
        return Arrays.asList(new ItemStack[]{new ItemStack(EMTBlocks.solar_darkcompressed)});
    }
}
